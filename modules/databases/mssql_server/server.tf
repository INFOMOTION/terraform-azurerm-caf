resource "azurerm_mssql_server" "mssql" {
  ...
  dynamic "azuread_administrator" {
    ...
    content {
      ...
      login_username              = try(var.settings.azuread_administrator.login_username, try(var.azuread_groups[var.settings.azuread_administrator.lz_key][var.settings.azuread_administrator.azuread_group_key].name, var.azuread_groups[var.client_config.landingzone_key][var.settings.azuread_administrator.azuread_group_key].name))
      object_id                   = try(var.settings.azuread_administrator.object_id, try(var.azuread_groups[var.settings.azuread_administrator.lz_key][var.settings.azuread_administrator.azuread_group_key].id, var.azuread_groups[var.client_config.landingzone_key][var.settings.azuread_administrator.azuread_group_key].id))
      tenant_id                   = try(var.settings.azuread_administrator.tenant_id, try(var.azuread_groups[var.settings.azuread_administrator.lz_key][var.settings.azuread_administrator.azuread_group_key].tenant_id, var.azuread_groups[var.client_config.landingzone_key][var.settings.azuread_administrator.azuread_group_key].tenant_id))
    }
  }
