locals {
  ...
  combined_objects_data_factory_linked_service_azure_databricks   = merge(tomap({ (local.client_config.landingzone_key) = module.data_factory_linked_service_azure_databricks }), try(var.remote_objects.data_factory_linked_service_azure_databricks, {}))
  # combined_objects_data_factory_linked_service_azure_file_storage     = merge(tomap({ (local.client_config.landingzone_key) = module.data_factory_linked_service_azure_file_storage }), try(var.remote_objects.data_factory_linked_service_azure_file_storage, {}))
  combined_objects_data_factory_linked_service_azure_function         = merge(tomap({ (local.client_config.landingzone_key) = module.data_factory_linked_service_azure_function }), try(var.remote_objects.data_factory_linked_service_azure_function, {}))
  combined_objects_data_factory_linked_service_azure_sql_database     = merge(tomap({ (local.client_config.landingzone_key) = module.data_factory_linked_service_azure_sql_database }), try(var.remote_objects.data_factory_linked_service_azure_sql_database, {}))
  ...
  combined_objects_data_factory_linked_service_data_lake_storage_gen2 = merge(tomap({ (local.client_config.landingzone_key) = module.data_factory_linked_service_data_lake_storage_gen2 }), try(var.remote_objects.data_factory_linked_service_data_lake_storage_gen2, {}))
  combined_objects_data_factory_linked_service_key_vault              = merge(tomap({ (local.client_config.landingzone_key) = module.data_factory_linked_service_key_vault }), try(var.remote_objects.data_factory_linked_service_key_vault, {}))
  ...
  #combined_objects_data_factory_linked_service_sftp                   = merge(tomap({ (local.client_config.landingzone_key) = module.data_factory_linked_service_sftp }), try(var.remote_objects.data_factory_linked_service_sftp, {}))
  ...
  combined_objects_data_lake_filesystems                  = merge(tomap({ (local.client_config.landingzone_key) = module.data_lake_filesystems }), try(var.remote_objects.data_lake_filesystems, {}))
