locals {
  remote_objects = {
    ...
    data_factory_linked_service_azure_databricks   = try(local.combined_objects_data_factory_linked_service_azure_databricks, null)
    #data_factory_linked_service_azure_file_storage     = try(local.combined_objects_data_factory_linked_service_azure_file_storage, null)
    #data_factory_linked_service_azure_function         = try(local.combined_objects_data_factory_linked_service_azure_function, null)
    data_factory_linked_service_azure_sql_database     = try(local.combined_objects_data_factory_linked_service_azure_sql_database, null)
    data_factory_linked_service_cosmosdb               = try(local.combined_objects_data_factory_linked_service_cosmosdb, null)
    data_factory_linked_service_data_lake_storage_gen2 = try(local.combined_objects_data_factory_linked_service_data_lake_storage_gen2, null)
    data_factory_linked_service_key_vault              = try(local.combined_objects_data_factory_linked_service_key_vault, null)
    ...
    #data_factory_linked_service_sftp                   = try(local.combined_objects_data_factory_linked_service_sftp, null)
    ...
    data_lake_filesystems                        = try(local.combined_objects_data_lake_filesystems, null)
